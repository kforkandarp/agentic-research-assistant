...
def _build_router_prompt() -> str:
    try:
        ...
        if os.path.exists(chunks_path):
            ...
            paper_list = "- Transformer, ResNet, BERT, DDPM, GPT-3, LoRA"
    except Exception:
        paper_list = "- Transformer, ResNet, BERT, DDPM, GPT-3, LoRA"
...
- "retrieval": The question asks about specific facts, architecture details, hyperparameters, or metrics from an ML paper, OR explicitly mentions a paper from our local corpus. ALWAYS use retrieval when a paper name or core paper concept is mentioned.
Local Ingested Papers:
  {paper_list}

- "web_search": The question asks about recent events, current state-of-the-art leaderboards, software versions, news, or work from 2025/2026, OR ML papers/architectures NOT in our local corpus.
